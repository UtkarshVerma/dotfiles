...
return {
...

  {
    ...
    keys = {
      ...
      { "<leader>fc", function() Snacks.picker.files({ cwd = vim.fn.stdpath("config"), follow = true }) end, desc = "Config files" },
      { "<leader>ff", function() Snacks.picker.files({ follow = true }) end,                                 desc = "Files" },
